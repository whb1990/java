...
public class CanCompleteCircuit {
     ...
     * @return
     */
    public static int canCompleteCurcuit(int[] gas, int[] cost) {
    ...
    public static void main(String[] args) {
        System.out.println(canCompleteCurcuit(new int[]{1, 2, 3, 4, 5}, new int[]{3, 4, 5, 1, 2}));
        System.out.println(canCompleteCurcuit(new int[]{2, 3, 4}, new int[]{3, 4, 3}));
    }
}
